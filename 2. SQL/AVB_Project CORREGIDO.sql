...
select 
	...
	a.last_name
from actor a 
where a.last_name ilike '%ALLEN%'; --Condicion con % corregida
...
order by total_alquileres DESC; --Orden descendente corregido
...
select *
from cliente_rentas_temporal; --Consulta corregida
...
from customer c 
join rental r 
	on c.customer_id = r.customer_id -- relacion entre tablas revisada y corregida.
join inventory i
